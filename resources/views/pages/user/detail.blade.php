            ...
            <div class="row s_product_inner">
                <div class="col-lg-6">
                    <div class="single-prd-item">
                        <img class="img-fluid" src="{{ asset('images/' . $product->image) }}" alt="Gambar Produk">
                    </div>
                </div>
                <div class="col-lg-5 offset-lg-1">
                    <div class="s_product_text">
                        ...
                        @if ($product->discount > 0)
                            <h6>
                                <del style="color: black;">{{ number_format($product->price, 0, ',', '.') }} Points</del>
                            </h6>
                            <h2 style="color: red;">
                                {{ number_format($product->price - ($product->price * $product->discount / 100), 0, ',', '.') }} Points
                                <span style="color: red; font-weight: normal;">{{ $product->discount }}%</span>
                            </h2>
                        @else
                            <h2 style="color: black;">{{ number_format($product->price, 0, ',', '.') }} Points</h2>
                        @endif
                        <ul class="list">
                            <li>
                                <a class="active" href="#">
